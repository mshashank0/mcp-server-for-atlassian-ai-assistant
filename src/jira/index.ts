...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    switch (name) {
      case 'jira_get_issue': {
        const result = await jira.getIssue(args.issue_key as string, {
          ...
          update_history: args.update_history as boolean | undefined,
        });
        return {
          content: [
            {
      ...
      case 'jira_search_issues': {
        const result = await jira.searchIssues(args.jql as string, {
          ...
          expand: args.expand as string | undefined,
          projects_filter: args.projects_filter as string | undefined,
        });
        return {
          content: [
            {
      ...
      case 'jira_get_board_issues': {
        const result = await jira.getBoardIssues(
      ...
      case 'jira_get_sprint_issues': {
        const result = await jira.getSprintIssues(args.sprint_id as string, {
          fields: args.fields as string[] | undefined,
          start: args.start as number | undefined,
          limit: args.limit as number | undefined,
        });
      ...
      case 'jira_get_issue_comments': {
        const result = await jira.getIssueComments(
          args.issue_key as string,
      ...
      case 'jira_batch_create_issues': {
        const result = await jira.batchCreateIssues(
          args.issues as any[],
          args.validate_only as boolean | undefined
        );
        return {
          content: [
            {
      ...
      case 'jira_get_issue_changelog': {
        ...
        const result = await jira.getIssueChangelog(issue_key as string, start_at as number, max_results as number);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_all_projects': {
        const result = await jira.getAllProjects(
      ...
      case 'jira_get_project': {
        const result = await jira.getProject(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_model': {
        const result = await jira.getProjectModel(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_project_exists': {
        const result = await jira.projectExists(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_components': {
        const result = await jira.getProjectComponents(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_versions': {
        const result = await jira.getProjectVersions(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_roles': {
        const result = await jira.getProjectRoles(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_my_project_permissions': {
        const result = await jira.getMyProjectPermissions(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_issue_types': {
        const result = await jira.getProjectIssueTypes(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_statuses': {
        const result = await jira.getProjectStatuses(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_issues_count': {
        const result = await jira.getProjectIssuesCount(args.project_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_project_issues': {
        const result = await jira.getProjectIssues(
          args.project_key as string,
      ...
      case 'jira_create_project_version': {
        const result = await jira.createProjectVersion(
          args.project_key as string,
          args.name as string,
      ...
      case 'jira_link_issue_to_epic': {
        const result = await jira.linkIssueToEpic(
          args.issue_key as string,
      ...
      case 'jira_get_epic_issues': {
        const result = await jira.getEpicIssues(
          args.epic_key as string,
          args.start as number | undefined,
          args.limit as number | undefined
        );
      ...
      case 'jira_get_all_sprints_from_board': {
        const result = await jira.getAllSprintsFromBoard(
          args.board_id as string,
      ...
      case 'jira_get_all_sprints_from_board_model': {
        const result = await jira.getAllSprintsFromBoardModel(
          args.board_id as string,
          args.state as string | undefined,
          args.start as number | undefined,
          args.limit as number | undefined
      ...
      case 'jira_create_sprint': {
        const result = await jira.createSprint(args.board_id as string, {
      ...
      case 'jira_get_all_active_sprints': {
        const result = await jira.getAllActiveSprints(
      ...
      case 'jira_get_sprint_details': {
        const result = await jira.getSprintDetails(args.sprint_id as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_start_sprint': {
        const result = await jira.startSprint(args.sprint_id as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_complete_sprint': {
        const result = await jira.completeSprint(args.sprint_id as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_add_worklog': {
        const result = await jira.addWorklog(args.issue_key as string, {
      ...
      case 'jira_get_worklog': {
        const result = await jira.getWorklog(args.issue_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_worklog_models': {
        const result = await jira.getWorklogModels(args.issue_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_worklogs': {
        const result = await jira.getWorklogs(args.issue_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_available_transitions': {
        const result = await jira.getAvailableTransitions(args.issue_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_transitions': {
        const result = await jira.getTransitions(args.issue_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_transitions_models': {
        const result = await jira.getTransitionsModels(args.issue_key as string);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_transition_issue': {
        const result = await jira.transitionIssue(
          args.issue_key as string,
      ...
      case 'jira_get_fields': {
        const result = await jira.getFields(args.refresh as boolean | undefined);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_field_id': {
        const result = await jira.getFieldId(
      ...
      case 'jira_get_field_by_id': {
        const result = await jira.getFieldById(
      ...
      case 'jira_get_custom_fields': {
        const result = await jira.getCustomFields(args.refresh as boolean | undefined);
        return {
          content: [
            {
              type: 'text',
      ...
      case 'jira_get_required_fields': {
        const result = await jira.getRequiredFields(
      ...
      case 'jira_search_fields': {
        const result = await jira.searchFields(
      ...
      case 'jira_get_issue_picker_suggestions': {
        const result = await jira.getIssuePickerSuggestions(
          args.query as string,
          args.current_issue_key as string | undefined,
          args.current_project_id as string | undefined
        );
        return {
          content: [
            {
